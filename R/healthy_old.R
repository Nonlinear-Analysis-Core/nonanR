...
#'
#' A subset of data from the NONAN Gaitprint data repository. The age range for healthy young people is over 55 years old. 
#'
#' @format `healthy_old`
...
#' @source 
#' Data:
#' <https://springernature.figshare.com/collections/NONAN_GaitPrint_An_IMU_gait_database_of_healthy_young_adults/6415061/1>
#' 
#' More details can be found at:
#' <https://doi.org/10.1038/s41597-023-02704-z>
"healthy_old"