...
//'
//'
//' @param x The length of the resulting time series
...
// [[Rcpp::export]]
arma::vec bayesH(arma::vec x, double H = 200) {
    
    arma::vec data = x;
    unsigned int n = H; //armaGetScalar<unsigned int>(prhs[1]);
